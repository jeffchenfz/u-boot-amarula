...
int sdram_detect_bw(struct rk3399_cap_info *cap_info)
{
	return 0;
}

int sdram_detect_cs(struct rk3399_cap_info *cap_info)
{
	return 0;
}
...
//	writel(0xffff, &dram->grf->soc_con0);
	/* enable all clk */
...
//	writel(0x3fffffff, &dram->pmu->pmu_noc_auto_ena);
